...
<nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 ">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
        <h6 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">zyad magdy</h6>
    </a>
    
    <div class="  md:block md:w-auto" id="navbar-solid-bg">
      <ul class="flex font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
